...
const projects = [
  ...
  },
  {
    ...
    description:
      "Enabled customer funnel and retention tracking for an e-commerce store, simulating a startup-grade analytics stack.",
              ...
              return (
                <ScrollAnimation key={project.id} animation="fade-in-up" delay={index * 100}>
                  <ImageCard className="bg-card/60 backdrop-blur-sm border-border/20 hover-lift hover-glow transition-all duration-300 group">
                    {/* Project Thumbnail */}
                    <ImageCardImage className={`aspect-video bg-gradient-to-br ${project.gradient} flex items-center justify-center relative overflow-hidden`}>
