        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollAnimation animation="fade-in-up">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-balance mb-6">
              I build batch and real-time data pipelines that deliver{" "}
              <span className="text-shimmer">reliable data</span> for analytics and machine learning
            </h1>
          </ScrollAnimation>

          <ScrollAnimation animation="fade-in-up" delay={200}>
            <p className="text-xl text-muted-foreground text-pretty mb-8 max-w-3xl mx-auto">
              I turn raw events into business-ready insights — from scalable ingestion and orchestration to ML-ready
